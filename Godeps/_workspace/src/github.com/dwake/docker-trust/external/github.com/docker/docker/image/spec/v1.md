...
<dl>
    ...
    <dd>
        ...
        algorithm are described in the separate <a href="https://github.com/dwake/docker-trust/external/github.com/docker/docker/blob/master/pkg/tarsum/tarsum_spec.md">TarSum specification</a>.
    </dd>
    <dt>
        Tag
    </dt>
