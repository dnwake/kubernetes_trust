...
import (
	...
	"github.com/dwake/docker-trust/external/github.com/docker/docker/pkg/pools"
	"github.com/dwake/docker-trust/external/github.com/docker/docker/pkg/reexec"
	sysinfo "github.com/dwake/docker-trust/external/github.com/docker/docker/pkg/system"
	"github.com/dwake/docker-trust/external/github.com/docker/docker/pkg/term"
	"github.com/dwake/docker-trust/external/github.com/opencontainers/runc/libcontainer"
	"github.com/dwake/docker-trust/external/github.com/opencontainers/runc/libcontainer/apparmor"
	"github.com/dwake/docker-trust/external/github.com/opencontainers/runc/libcontainer/cgroups/systemd"
	"github.com/dwake/docker-trust/external/github.com/opencontainers/runc/libcontainer/configs"
	"github.com/dwake/docker-trust/external/github.com/opencontainers/runc/libcontainer/system"
	"github.com/dwake/docker-trust/external/github.com/opencontainers/runc/libcontainer/utils"
)
