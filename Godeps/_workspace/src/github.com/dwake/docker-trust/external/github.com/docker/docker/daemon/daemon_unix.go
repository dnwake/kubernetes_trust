...
import (
	...
	"github.com/dwake/docker-trust/external/github.com/docker/docker/pkg/parsers"
	"github.com/dwake/docker-trust/external/github.com/docker/docker/pkg/parsers/kernel"
	...
	runconfigopts "github.com/dwake/docker-trust/external/github.com/docker/docker/runconfig/opts"
	pblkiodev "github.com/dwake/docker-trust/external/github.com/docker/engine-api/types/blkiodev"
	...
	nwconfig "github.com/dwake/docker-trust/external/github.com/docker/libnetwork/config"
	"github.com/dwake/docker-trust/external/github.com/docker/libnetwork/drivers/bridge"
	"github.com/dwake/docker-trust/external/github.com/docker/libnetwork/ipamutils"
	"github.com/dwake/docker-trust/external/github.com/docker/libnetwork/netlabel"
	"github.com/dwake/docker-trust/external/github.com/docker/libnetwork/options"
	"github.com/dwake/docker-trust/external/github.com/docker/libnetwork/types"
	blkiodev "github.com/dwake/docker-trust/external/github.com/opencontainers/runc/libcontainer/configs"
	"github.com/dwake/docker-trust/external/github.com/opencontainers/runc/libcontainer/label"
	"github.com/dwake/docker-trust/external/github.com/opencontainers/runc/libcontainer/user"
)
...
func checkKernel() error {
	...
	// For details see https://github.com/dwake/docker-trust/external/github.com/docker/docker/issues/407
