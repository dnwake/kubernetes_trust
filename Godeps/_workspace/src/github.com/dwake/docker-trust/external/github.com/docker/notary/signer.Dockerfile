...
ENV NOTARYPKG github.com/dwake/docker-trust/external/github.com/docker/notary
ENV GOPATH /go/src/${NOTARYPKG}/Godeps/_workspace:$GOPATH

EXPOSE 4444

# Copy the local repo to the expected go path
COPY . /go/src/github.com/dwake/docker-trust/external/github.com/docker/notary
